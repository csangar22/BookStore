...
if (isset($_SESSION['message'])) {
    if (is_array($_SESSION['message'])) {
        $message = $_SESSION['message']['text']; // Acceder al texto dentro del array de mensaje
    } else {
        $message = $_SESSION['message']; // Si no es un array, asumimos que es una cadena de texto
    }
    unset($_SESSION['message']); // Limpiar el mensaje para que no se muestre nuevamente
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <main>
        <div class="signup-container">
            ...
            <p>Introduce tu correo y contraseña para iniciar sesión</p>
            ...
            <p class="terms">Al hacer clic en continuar, aceptas nuestros <a href="#">Términos de servicio</a> y <a href="#">Política de privacidad</a></p>
        </div>
    </main>
    <!--Footer-->
    <footer class="footer">
